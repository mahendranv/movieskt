...
public val AppIcons.Starfillled: ImageVector
    get() {
        if (_starfillled != null) {
            return _starfillled!!
        }
        _starfillled = Builder(name = "Starfillled", defaultWidth = 512.0.dp, defaultHeight =
...
private var _starfillled: ImageVector? = null
